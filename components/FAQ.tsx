      ...
      <div className="max-w-6xl mx-auto">
                  ...
                  <div className="border-t border-white/10 pt-4">
                    ...
                    {item.cta && (
                      <motion.button
                        ...
                        whileTap={{ scale: 0.98 }}
                        className="mt-4 bg-gradient-to-r from-green-600 to-green-500 text-white px-6 py-3 rounded-lg text-sm font-semibold hover:shadow-lg transition-all duration-300 inline-flex items-center gap-2"
                      >
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-gradient-to-r from-green-600 to-green-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:shadow-xl transition-all duration-300 inline-flex items-center gap-3"
          >
