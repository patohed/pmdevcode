...
const WhatsAppIcon = ({ className = "w-5 h-5 sm:w-5 sm:h-5" }: { className?: string }) => (
          ...
          {packages.map((pkg, index) => (
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className={`group w-full py-3 px-4 sm:py-4 sm:px-6 rounded-xl font-semibold text-base sm:text-lg transition-all duration-300 flex items-center justify-center space-x-1 sm:space-x-2 ${
                  selectedCard === index
              ...
              >
                {selectedCard === index ? (
                  <>
                    <WhatsAppIcon className="w-5 h-5 sm:w-5 sm:h-5" />
                  ...
                  <>
                    ...
                    <span className="sm:hidden">{pkg.popular ? 'Presencia Web' : 'E-commerce'}</span>
                    <motion.svg 
