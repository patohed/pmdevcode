...
const WhatsAppIcon = ({ className = "w-5 h-5 sm:w-4 sm:h-4" }: { className?: string }) => (
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900">
      ...
      >
        ...
        <motion.h1
          variants={itemVariants}
          className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black mb-6 leading-[0.95] sm:leading-[0.9] tracking-tight px-2 sm:px-0"
        >
          ...
          <span className="block text-white text-3xl sm:text-4xl md:text-5xl lg:text-8xl">con Webs que</span>
          <motion.span 
        ...
        {/* Subheadline - Mejorado para móvil */}
        <motion.p
          variants={itemVariants}
          className="text-base sm:text-lg md:text-xl lg:text-2xl text-gray-300 mb-8 sm:mb-12 leading-relaxed max-w-4xl mx-auto font-light px-4 sm:px-0"
        >
          Desarrollo web profesional con enfoque en{" "}
          <span className="text-white font-semibold">resultados medibles</span>.
          <br className="hidden sm:block" />
          <span className="block sm:inline">Plataformas que generan leads, ventas y crecimiento real para tu empresa.</span>
        </motion.p>

        {/* CTA buttons - Optimizado para móvil con mejor espaciado */}
        <motion.div
          variants={itemVariants}
          className="flex flex-col space-y-4 items-center justify-center mb-12 sm:mb-16 px-4 sm:px-0"
        >
          <Link href="/cotizar" className="w-full sm:w-auto max-w-sm">
            <motion.button
              whileHover={{ 
                scale: 1.02,
              ...
              whileTap={{ scale: 0.95 }}
              className="group bg-gradient-to-r from-blue-600 via-blue-700 to-blue-600 hover:from-blue-700 hover:via-blue-800 hover:to-blue-700 text-white px-8 sm:px-12 py-4 sm:py-5 rounded-2xl text-lg sm:text-xl lg:text-2xl font-bold hover:shadow-2xl transition-all duration-300 flex items-center space-x-3 sm:space-x-4 w-full justify-center relative overflow-hidden"
            >
              <motion.div 
              ...
              >
                <svg className="w-5 sm:w-6 lg:w-7 h-5 sm:h-6 lg:h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Link href="/portfolio" className="w-full sm:w-auto max-w-sm">
            <motion.button
              whileHover={{ 
                scale: 1.02,
              ...
              whileTap={{ scale: 0.95 }}
              className="group border-2 border-blue-400/40 text-white px-6 sm:px-10 py-3 sm:py-4 rounded-2xl text-base sm:text-lg lg:text-xl font-semibold hover:border-blue-300 transition-all duration-300 flex items-center space-x-3 w-full justify-center backdrop-blur-sm bg-white/5"
            >
